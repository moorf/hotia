        ...
        private void load()
        {
            Children = new Drawable[]
            {
                ...
                stackLeniency = new FormSliderBar<float>
                {
                    ...
                    HintText = "In play mode, hotia! automatically stacks notes which occur at the same location. Increasing this value means it is more likely to snap notes of further time-distance.",
                    KeyboardStep = 0.1f,
