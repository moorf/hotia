...
namespace osu.Game.Localisation
{
    public static class LayoutSettingsStrings
    {
        ...
        /// <summary>
        /// "hotia! is running in exclusive fullscreen, guaranteeing low latency!"
        /// </summary>
        public static LocalisableString OsuIsRunningExclusiveFullscreen => new TranslatableString(getKey(@"osu_is_running_exclusive_fullscreen"), @"hotia! is running in exclusive fullscreen, guaranteeing low latency!");
