...
namespace osu.Game.Localisation
{
    public static class LeaderboardStrings
    {
        ...
        /// <summary>
        /// "Please invest in an hotia!supporter tag to view this leaderboard!"
        /// </summary>
        public static LocalisableString PleaseInvestInAnOsuSupporterTagToViewThisLeaderboard => new TranslatableString(getKey(@"please_invest_in_an_osu_supporter_tag_to_view_this_leaderboard"), @"Please invest in an hotia!supporter tag to view this leaderboard!");
