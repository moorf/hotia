...
namespace osu.Game.Localisation
{
    public static class FirstRunSetupBeatmapScreenStrings
    {
        ...
        /// <summary>
        /// "&quot;Beatmaps&quot; are what we call sets of playable levels. hotia! doesn&#39;t come with any beatmaps pre-loaded. This step will help you get started on your beatmap collection."
        /// </summary>
        public static LocalisableString Description => new TranslatableString(getKey(@"description"), @"""Beatmaps"" are what we call sets of playable levels. hotia! doesn't come with any beatmaps pre-loaded. This step will help you get started on your beatmap collection.");
        ...
        /// <summary>
        /// "Get the hotia! tutorial"
        /// </summary>
        public static LocalisableString TutorialButton => new TranslatableString(getKey(@"tutorial_button"), @"Get the hotia! tutorial");
