...
namespace osu.Game.Localisation
{
    public static class BeatmapSubmissionStrings
    {
        ...
        /// <summary>
        /// "Note: In order to make it possible for users of all hotia! versions to enjoy your beatmap, it will be exported in a backwards-compatible format. While we have made efforts to ensure that this process keeps the beatmap playable in its intended form, some data related to features that previous versions of hotia! do not support may be lost."
        /// </summary>
        public static LocalisableString LegacyExportDisclaimer => new TranslatableString(getKey(@"legacy_export_disclaimer"), @"Note: In order to make it possible for users of all hotia! versions to enjoy your beatmap, it will be exported in a backwards-compatible format. While we have made efforts to ensure that this process keeps the beatmap playable in its intended form, some data related to features that previous versions of hotia! do not support may be lost.");
