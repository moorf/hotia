...
namespace osu.Game.Beatmaps.Formats
{
    public class LegacyStoryboardDecoder : LegacyDecoder<Storyboard>
    {
            ...
            else
            {
                ...
                switch (commandType)
                {
                    case "T":
                    {
                        ...
                        // negation as per https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/hotia!/GameplayElements/HitObjectManager_LoadSave.cs#L736
        ...
        /// </remarks>
        /// <seealso href="https://github.com/peppy/osu-stable-reference/blob/c34a74fb61c17c5667486a12548485d1f03baa2e/hotia!/GameplayElements/HitObjectManager_LoadSave.cs#L1105-L1110"/>
