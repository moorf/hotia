...
namespace osu.Game.Beatmaps
{
    ...
    public class LocalCachedBeatmapMetadataSource : IOnlineBeatmapMetadataSource
    {
        ...
        public Task FetchCache()
        {
            ...
            cacheDownloadRequest = new FileWebRequest(compressedCacheFilePath, $@"https://assets.hotia.org/client-resources/{cache_database_name}.bz2?{DateTimeOffset.UtcNow:yyyyMMdd}");
