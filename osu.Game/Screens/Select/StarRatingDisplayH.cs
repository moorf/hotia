...
namespace osu.Game.Beatmaps.Drawables
{
    ...
    /// </summary>
    public partial class StarRatingDisplayH : CompositeDrawable, IHasCurrentValue<StarDifficulty>
    {
        ...
        public StarRatingDisplayH(StarDifficulty starDifficulty, StarRatingDisplaySize size = StarRatingDisplaySize.Regular, bool animated = false)
        {
            ...
            switch (size)
            {
                ...
                case StarRatingDisplaySize.Regular:
                    margin = new MarginPadding { Horizontal = 8f, Vertical = 6f };
                    break;
            }
