...
namespace osu.Game.Tests.Visual.Online
{
    ...
    public partial class TestSceneUserPanel : OsuTestScene
    {
        ...
        public void TestUserActivity()
        {
            ...
            AddStep("solo (hotia!)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(0)));
            AddStep("solo (hotia!taiko)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(1)));
            AddStep("solo (hotia!catch)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(2)));
            AddStep("solo (hotia!mania)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(3)));
        ...
        public void TestLocalUserActivity()
        {
            ...
            AddStep("solo (hotia!)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(0), API.LocalUser.Value.OnlineID));
            AddStep("solo (hotia!taiko)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(1), API.LocalUser.Value.OnlineID));
            AddStep("solo (hotia!catch)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(2), API.LocalUser.Value.OnlineID));
            AddStep("solo (hotia!mania)", () => setPresence(UserStatus.Online, soloGameStatusForRuleset(3), API.LocalUser.Value.OnlineID));
